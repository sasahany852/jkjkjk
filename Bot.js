...
client.on('messageCreate', async Message => {
    ...
    if (Command == 'setup') {
        ...
        const Embed = new EmbedBuilder()
            .setAuthor({ name: '♕MØĞRÈM_ĞÀMÈ♕', iconURL: client.user.displayAvatarURL() })
            .setDescription(`Click the button to control your temporary channel on my server ﴾♕MØĞRÈM_ĞÀMÈ♕﴿`)
            .setTimestamp()
